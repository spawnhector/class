<div class="side-menu sidebar-inverse">
    <nav class="navbar navbar-default" role="navigation">
        <div class="side-menu-container">
            <div class="navbar-header" style="height:48px;background-color:#1e40af">
                <a class="navbar-brand" href="<?php echo e(route('voyager.dashboard')); ?>">
                    ...
                    <div class="title"><?php echo e(Voyager::setting('admin.title', 'HHUB')); ?></div>
                </a>
            </div><!-- .navbar-header -->
...
<?php /**PATH C:\xampp\htdocs\xampp\hhub\resources\views/dashboard/sidebar.blade.php ENDPATH**/ ?>