    ...
    <div class="flex justify-between items-center h-14 bg-blue-800 dark:bg-gray-800 header-right">
     ...
     <button aria-hidden="true" @click="toggleTheme"
         ...
         <svg x-show="!isDark" width="24" height="24"
            ...
            <div class="top-top">
                <div class="search2 search3 container" id="search2">
                ...
                <ul>
                    @if (Auth::user()->unreadNotifications->count() > 0)
                        <div class='wrapper' onclick="showNotification()">
                            ...
                            <svg width="100px" height="70px" viewBox="0 0 1280 800" version="1.1"
    ...
    $(document).ready(function() {
        ...
        $(document).on('keyup','#search1',function () {
            ...
            if (query != "") {
                ...
                const $ = selector => document.querySelector(selector)
                document.getElementById('search1').placeholder = 'Search WEHUB..'
                // console.log('Search WEHUB..')
            }
        })
