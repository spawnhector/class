    ...
    @section('content')
        ...
        <div x-data="setup()" :class="{ 'dark': isDark }">
            <div class="min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-white dark:bg-gray-700 text-black dark:text-white"
                ...
                <form action={{ route('dashboard.post.update',[$ir]) }} method="post" enctype="multipart/form-data">
                    @csrf
                                            ...
                                            <div class="post-form">
                                                ...
                                                <div class="post-section">
                                                    ...
                                                    <div class="post-title">
                                                        <input type="text" name="title" id="post-title" value="{{$title}}"
                                                            class="post-input large" placeholder="Title..." />
                                                    </div>
                                                    <div class="post-content">
                                                        <textarea name="content" class="post-input" value=""
                                                            placeholder="Content..."></textarea>
                                                    </div>
                                                </div>
                                                <div class="post-section post-media">
                                                    <div class="post-media-icon btn btn-default">
                                                        <img src="http://localhost/xampp/myblog/storage/app/public/{{ $image }}"
                                ...
                                <div class="panel panel-bordered panel-info" style="margin-top: 20px">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            {{-- {{dd($keyword)}} --}}
                                            <textarea class="form-control" name="meta_keywords" placeholder="{{$keyword}}"></textarea>
                                        </div>
                                        <div class="form-group">
