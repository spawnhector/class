...
.border-fade:hover {
    box-shadow: inset 0 0 3px 2px #666, 0 0 1px rgb(0 0 0 / 0%);
}
...
.curl-top-left:before {
  ...
  background: #6660;
  /* IE9 */
  background: linear-gradient(135deg, #6660 45%, #aaa 50%, #ccc 56%, #6660 80%);
...
.curl-bottom-left:before {
  ...
  background: #6660;
  /* IE9 */
  background: linear-gradient(45deg, #6660 45%, #aaa 50%, #ccc 56%, #6660 80%);
  box-shadow: 1px -1px 1px rgba(0, 0, 0, 0.4);
  transition-duration: 0.3s;
  transition-property: width height;
}
