...
class antibotlinks {
    ...
    public function __construct($use_gd=true, $font_type='') {
        ...
        foreach (fb_load_settings() as $faucet_settings_name=>$faucet_settings_value) {
...
function abl_claim_loop() {
    $.post(\''.basename($_SERVER['PHP_SELF']).'\', {action:\'ajax_abl_get_claim_log\', last_id:abl_claim_last_id, csrftoken:\''.isset($_SESSION['_token'.$session_prefix]).'\'})
