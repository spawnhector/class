...
if (!empty($_POST['p'])) {
  ?>
<link rel="canonical" href="<?php echo 'http'.(($_SERVER['SERVER_PORT']==80)?'':'s').'://'.$_SERVER['HTTP_HOST'].'/?p='.urlencode($_POST['p']); ?>" />
<?php
} else {
  ?>
    ...
    <div id="page-cols">
				<div class="page-col-body">
					...
					<div id="header">
                        ...
                        <div class="balance">CryptoPub [<?php echo $data["currency"]; ?>] Faucet Balance: <?php echo $data["balance"]." ".$data["unit"]; ?></div>
					...
					<div id="main">
						...
						<?php switch($data["page"]):
							...
							<div id="disabled-box">
								...
								<div class="desc">Go to <?php adminPage()?>
                ...
                echo $data["referred_users"];
							...
							<form method="POST">
                                <?php echo csrf_field();?>
                                <input type='hidden' name='faucet' value='<?php echo dencrypt('CryptoPub');?>'>
                                <div class="step1">
                                    <div>
                                ...
                                <div class="step2">
                                    <div>
                                        <label class="main-input-label">Your [<?php echo $data["currency"]; ?>] address:</label>
...
# AntiBotLinks START
?>
                        <?php echo antibotlink()->show_info(); ?>
<?php
# AntiBotLinks END
?>
<?php
...
<script type="text/javascript" src="{{asset('js/faucetinabox/button-timer.js')}}"></script>
{{-- <script type="text/javascript" src="{{asset('js/faucetinabox/test.js')}}"></script> --}}
