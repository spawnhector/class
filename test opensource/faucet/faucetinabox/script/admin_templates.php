                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <a class="service_link service_link_microwallet" target="_blank" href="https://www.microwallet.co/ref/MakeJar">MicroWallet.co</a>
                            <a class="service_link service_link_walcrypt" target="_blank" href="https://www.walcrypt.com/register?ref=1174">WalCrypt.com</a>
                            <a class="service_link service_link_microcoinpay" target="_blank" href="https://microcoinpay.com/r/319">MicroCoinPay.com</a>
                        </div>
                        <div class="form-group">
                            <:: invalid_key ::>
...
$(function() {
    ...
    $(function() {
        ...
        $("#admin-form input[type=submit], #admin-form button[type=submit]").click(function (e) {
            ...
            $.post("<:: admincheck ::>", { encoded_data: encoded_data }, function(data) {
...
<form method="POST">
    <:: csrftoken ::>
    <input name="p" class="hidden" value="password-reset">
...
$test = redirectPr('faucet','Click here to continue',
"
...
<div class="alert alert-info" role="alert">
    Your password: <:: password ::>. Make sure to save it. $test.
</div>
TEMPLATE;
