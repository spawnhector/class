...
include 'C:\xampp\htdocs\xampp\test opensource\cryptoPub\resources\views\faucet\faucetinabox\libs/functions.php';
include 'C:\xampp\htdocs\xampp\test opensource\cryptoPub\resources\views\faucet\faucetinabox\libs/services.php';
...
if ((empty($_SESSION['r'.$session_prefix]))&&(!empty($_POST['r']))) {
    $_SESSION['r'.$session_prefix]=$_POST['r'];
}
if ((empty($_POST['r']))&&(!empty($_SESSION['r'.$session_prefix]))) {
    $_POST['r']=$_SESSION['r'.$session_prefix];
}
...
if ((!$pass) || ($faucet_settings_array['version']<$version)) {
    include ''.faucetbox_path().'script/install.php';
}
