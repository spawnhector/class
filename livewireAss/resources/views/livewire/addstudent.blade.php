            ...
            <div class="mt-8">
              ...
              <div class="mt-2">
                  ...
                  <div>
                    ...
                    <div class="mt-1">
                      <input wire:model="student_first_nm" id="student_first_nm" name="student_first_nm" type="text" required="" placeholder="First Name" class="{{input_button}}">
                    </div>
                  </div>
                  <div class="mt-2">
                    <label for="student_last_nm" class="block text-sm font-medium text-neutral-600"> Student last Name </label>
                    <div class="mt-1">
                      <input wire:model="student_last_nm" id="student_last_nm" name="student_last_nm" type="text" required="" placeholder="Last Name" class="{{input_button}}">
                    </div>
                  </div>
                  <div class="mt-2">
                  ...
                  <div class="mt-2">
                    ...
                    <div class="mt-1">
                      <input wire:model="student_email" id="email" name="email" type="email" autocomplete="email" required="" placeholder="Your Email" class="{{input_button}}">
                    </div>
                  </div>
                  <div>
                    <button type="submit" class="{{submit_button}}" wire:click="addStudent()"> Add Student </button>
                  </div>
              </div>
            </div>
          </div>
