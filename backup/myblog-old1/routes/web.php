...
Route::group(['middleware' => 'auth'], function (){
    ...
    Route::post('dashboard/{id}/follow', 'App\Http\Controllers\DashboardController@follow')->name('follow');
    Route::post('dashboard/{id}/unfollow', 'App\Http\Controllers\DashboardController@unfollow')->name('unfollow');
    Route::post('dashboard/{id}/friend', 'App\Http\Controllers\DashboardController@friend')->name('friend');
    Route::post('dashboard/{id}/confirm-friend', 'App\Http\Controllers\DashboardController@toconfirmfriend')->name('toconfirmfriend');
    Route::get('dashboard/Post', 'App\Http\Controllers\DashboardController@index')->name('dashboard.show');
    Route::get('dashboard/show-post/{id}/{is}', 'App\Http\Controllers\DashboardController@show_post')->name('show-post');
