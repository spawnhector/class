                    ...
                    <div class="container">
                        ...
                        <div class="profile1">
                            ...
                            <div class="profile-user-settings">
                                ...
                                @endif
                                @if ($confirmed == 2)
                                    <div onclick="confirm_friend(this,{{ $id }})" class="btn profile-edit-btn"><div id="confirm-no" style="display: block;">Confirm Request</div><div id="confirm-yes" style="display: none;">Request Confirmed</div></div>
                                @endif
                                <?php 
                                $check_follow = 0;
