<x-app-layout>
    ...
    @section('content')
                    ...
                    <div class="container">
                        ...
                        <div class="profile1">
                            ...
                            <div class="profile-user-settings">
                                ...
                                @endif
                                @if ($confirmed == 2)
                                    <div id="to-confirm"><div onclick="confirm_friend(this,{{ $id }})" class="btn profile-edit-btn"><div id="confirm-no" style="display: block;">Confirm Request</div><div id="confirm-yes" style="display: none;">Request Confirmed</div></div></div>
                                @endif
                            ...
                            <div class="profile-stats">
                                ...
                                <ul>
                                    ...
                                    <li><span class="profile-stat-count" id="friends">{{ $friends_count }}</span> friends</li>
        ...
        <script>
            ...
            function confirm_friend(elmnt, clr) {
                if (document.getElementById('confirm-no').style.display == "block") {
                    document.getElementById('confirm-no').style.display = "none";
                    document.getElementById('confirm-yes').style.display = 'block';
                    const xhttp = new XMLHttpRequest();
                    let url = new URL('http://127.0.0.1:8000/dashboard/'+clr+'/confirm-friend');
                    xhttp.onload = function() {
                        document.getElementById('friends').innerHTML = this.responseText
                        setTimeout(() => {
                            document.getElementById('to-confirm').style.display = 'none';
            ...
            // const confirm = (elem) => {
                ...
                //     url: "/dashboard/"+elem+"/confirm-friend",
                //     type: "POST",
                //     data: {id: elem},
                //     success: function(response) {
                //         alert('Ajax form has been submitted successfully '.concat(elem));
